...
6. 수입에는 v36 상승폭, 수출에는 v34 하락폭을 연결하고 ±3/5/10% 고정
   스트레스도 계산합니다.
7. 위험 원인, 안정성·균형·비용 후보, 공식자료와 상담 준비사항을 봅니다.
8. JSON·Markdown 결과를 내려받아 사람 검토로 넘깁니다.
...
검사를 한 명령으로 실행합니다. 2026-07-28 기준 273개 테스트가 통과했습니다.
최신 실제 실행 결과는
