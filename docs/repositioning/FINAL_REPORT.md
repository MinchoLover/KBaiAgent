...
> report critic을 추가했습니다. 현재 검증은 240개 PASS이며 최신 실행·제한은
...
| 전체 단위·통합·UI | `.venv/bin/python -m unittest discover -s tests -v` | 240개 성공, 0개 실패 |
...
않습니다. 실제 OpenAI live 평가는 외부 자격증명 필요로 미실행입니다.
