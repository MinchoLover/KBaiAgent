...
- 내부 Stage 0~5를 문서 확인·위험 진단·대응안 비교·상담자료 4단계 UI로 통합
- 밝은 B2B 금융 테마, 간결한 사이드바와 핵심 결과 우선 레이아웃 적용
- 문서 핵심 필드와 추가정보를 분리하고 evidence 오류를 쉬운 확인 문구로 표시
- 환율 근거·추가 자금·세부 계산표·JSON·trace를 접힌 상세 영역으로 이동
- 대응 후보의 추천 순위 표현을 제거하고 상담용 Markdown 다운로드를 우선 배치
