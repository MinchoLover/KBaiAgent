...
- Cases evaluated: 17
- Successful API/prediction records: 17
...
- Event-based due-date preservation: 0.00%
...
- Blocked-case accuracy: 0.00%

## Evidence

- Core field evidence coverage: 100.00%
- Evidence field-link consistency: 98.73%
- Confirmed values without evidence: 5
- Confirmed values without source_text: 5
